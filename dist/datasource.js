                ...
                _createClass(GenericDatasource, [{
                    ...
                    value: function buildQueryParameters(options) {
                        ...
                        var targets = _.map(options.targets, function (target) {
                            ...
                            sql = sql.replace("$__timeFilter", _this.format(options.range.from) + ":" + _this.format(options.range.to));
                            return {
                                rawSql: _this.templateSrv.replace(sql, options.scopedVars, 'regex'),
                                refId: target.refId,
                                hide: target.hide,
